...
int main(int argc, char **argv)
{
	...
	char* devCam2 = "/dev/video1";

	char* filename1 = "vid_cam1";
	char* filename2 = "vid_cam2";
	...
	Camera cam2(filename2,devCam2, 2, ancho2, alto2, ratefps2);
	...
	char* name1, name2;
		...
		for(;;){
			...
			ban2 = cam2.getFrame(ss2.str().c_str());
			...
			cam2.imageProcess(ss2.str().c_str());
